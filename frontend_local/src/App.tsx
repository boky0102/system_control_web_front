...
function App() {
    ...
    //const [touchPos, setTouchPos] = useState({ x: 0, y: 0 } as pos);
    //const [addToCursor, setAddToCursor] = useState({ x: 0, y: 0 } as pos);
    ...
    function handleTouchStart(event: React.TouchEvent<HTMLDivElement>) {
        ...
        console.log("Pressed");
        console.log("FIRST PRESS VALUE", touchPos);
        console.log("ELEM CENTER", elemCenter);
